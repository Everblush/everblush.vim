...
set background=dark
set t_Co=256
hi Normal guifg=#d6d6d6 ctermbg=NONE guibg=#0f1315 gui=NONE

hi CursorLineNR guibg=NONE guifg=#262d2f 
hi CursorLine guibg=#262d2f
hi DiffText guifg=#e7ac7e guibg=NONE
hi ErrorMsg guifg=#e74c4c guibg=NONE
hi WarningMsg guifg=#292d2e guibg=NONE
hi PreProc guifg=#6bb05d guibg=NONE
hi Exception guifg=#262d2f guibg=NONE
...
hi Debug guifg=#d6d6d6 guibg=NONE
...
hi Include guifg=#7ab3c3 guibg=NONE
...
hi StatusLine gui=italic guibg=#0f1315 guifg=#d6d6d6
hi StatusLineNC gui=NONE guibg=#0f1315 guifg=#d6d6d6
